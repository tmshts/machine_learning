...
Original file is located at
    https://colab.research.google.com/drive/1p2pY7Mxb4L6Jy6oNx4cN2BoigDVs_gYM
"""
...
if __name__ == '__main__':
    ...
    # Flatten the images of the testv set into 1D vectors
    x_test_reshaped = tf.reshape(x_test, [-1, 32 * 32 * 3])
    #print(x_test_reshaped.shape)
    y_pred_task1 = model_task1.predict(x_test_reshaped)
    #print(y_pred_task1)
    #print(y_test)
    #print(new_y)
    ...
    print("Accuracy model task 2:", acc1)